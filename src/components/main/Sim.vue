        ...
        <div>
          ...
          <div class="service-card-bottom">
            <button class="btn btn-secondary ripple">
              ...
              <svg class="mdi mdi-arrow-right float-right" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="m556-258-38-39 158-158H180v-54h496L518-667l38-39 224 224-224 224Z"/></svg>
